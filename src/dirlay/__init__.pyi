...
from dirlay.types import NodeTree, NodeValue, Path as Path, PathType
...
class Node(object):
    ...
    is_dir: bool
    data: 'NodeValue'
    def __init__(self, key: str, path: PathType, base: NodeTree): ...
    def __repr__(self) -> str: ...

MutableNodeTree: TypeAlias = MutableMapping[str, 'MutableNodeValue']
MutableNodeValue: TypeAlias = Union[MutableNodeTree, str]

class Dir:
    _tree: NestedDict[MutableNodeTree]
    ...
    def __or__(self, entries: Union[Dir, NodeTree]) -> 'Dir': ...
    def __ior__(self, entries: Union[Dir, NodeTree]) -> 'Dir': ...
    def __enter__(self) -> 'Dir': ...
    def __exit__(self, exc_type: Any, exc_val: Any, exc_tb: Any) -> 'Dir': ...
    def copy(self) -> 'Dir': ...
    def update(self, entries: Union[Dir, NodeTree], exist_ok: bool = ...) -> None: ...
